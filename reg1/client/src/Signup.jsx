...
function Signup() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post('http://localhost:3001/register', { name, email, address, age, password })
        .then(result => {
            console.log(result);
            navigate('/login');
        })
            ...
            <div className="bg-white p-3 rounded w-25">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-3">
                        ...
                        <input type="age" placeholder="Enter Age" autoComplete="off" name="age" className="form-control rounded-0"
